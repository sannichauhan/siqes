...
<html>
	...
	<head>
		<?php
			$seo_query = mysql_query("select * from sqs_meta_seo where page_name= 'partner_page'");
			...
			<div id="page-content">
				...
				<div class="container partners">
					<div class="row"> 
						...
						<?php
							$part_query = mysql_query("select * from sqs_partners where status = 1 order by part_title");
							$part_count = mysql_num_rows($part_query);
							while($part = mysql_fetch_array($part_query))
							{ ?>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="image-box">
								<div class="image-box-thumbnail">
									<img src="doc/partner/<?php echo $part['part_logo']; ?>" alt="">
								</div><!-- image-box-thumbnail -->
								<h6 class="res_client_name"><?php echo $part['part_title']; ?></h6>
								<div class="image-box-content">
									<h6><?php echo $part['part_title']; ?></h6>
