...
<body>
    <div class="wrapper"> 
        ...
        <div class="content">
            ...
            <div class="workplace">
				<form name="frmcblogcategory" action="" method="post" onsubmit="return validBlogcategory();" enctype="multipart/form-data"> 
					<div class="row-fluid">
						<div class="span12">
							...
							<div class="block-fluid">
								<div class="row-form clearfix" >
									...
									<div class="span4"> 
									   <input type="text" name="cat_name" class="cat_name" maxlength="65" onkeypress="return nameCharacter(event)"/>
									</div>
								</div>
								<div class="row-form clearfix" >    
