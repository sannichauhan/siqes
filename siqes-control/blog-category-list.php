					...
					<div class="span12">
						<div class="head clearfix">
							...
							<li>
								...
								<ul class="dd-list">
									<li><a href="add-blog-category.php"><span class="isw-plus"></span>Add New</a></li>
								</ul>
							</li>
						</ul>           
						</div>
						<div class="block-fluid">
							...
							<thead>
								<tr>	
									<th width="15%">Blog Category Title</th>
							...
							<tbody> 
								<?php
                                    ...
                                    $sql = mysql_query("select * from sqs_blog_category order by blog_category");
                                    $count = mysql_num_rows($sql);
									
                                    if($count>0){
                                        
                                        $sql_count="select * from sqs_blog_category order by blog_category";
								...
								?>
								<tr>
								<td><?php echo $rows['blog_category']; ?></td>
								...
								<td>
									<a href="edit-blog-category.php?action=editBlogCategory&id=<?php echo $rows['id'] ?>">
										<i class="isb-edit"></i>
									</a>
