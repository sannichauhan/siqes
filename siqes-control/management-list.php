					...
					<div class="span12">
						<div class="head clearfix">
							...
							<li>
								...
								<ul class="dd-list">
									<li><a href="add-management.php"><span class="isw-plus"></span>Add New</a></li>
								</ul>
							</li>
						</ul>           
						</div>
						<div class="block-fluid">
							...
							<tbody> 
								<?php
                                    ...
                                    $sql = mysql_query("select * from sqs_management order by created_on desc");
                                    $count = mysql_num_rows($sql);
									
                                    if($count>0){
                                        
                                        $sql_count="select * from sqs_management order by created_on desc";
								...
								?>
								<tr>
								<td><?php echo $rows['manag_name']; ?></td>
								<td><a class="fancybox" rel="profile" href="<?php echo '../doc/management/'.$rows['manag_image'] ?>" ><img  width="40" src="<?php echo '../doc/management/'.$rows['manag_image'] ?>" class="img-polaroid"></a></td>
								<td><?php echo $rows['manag_desig']; ?></td>
								<td><?php $str= $rows['manag_desc'];
								if(strlen($str)>70)
								{
										$pos= strpos($str, ' ', 70);
										echo substr($str,0,$pos);
								}else{
									echo $rows['manag_desc'];
								}
										?></td>
								...
								<td>
									<a href="edit-management.php?action=editManagement&manag_id=<?php echo $rows['manag_id'] ?>">
										<i class="isb-edit"></i>
									</a>
