...
<body>
    <div class="wrapper"> 
        ...
        <div class="content">
            ...
            <div class="workplace">
				<form name="frmservices" action="" method="post" onsubmit="return validServices();" enctype="multipart/form-data"> 
					<div class="row-fluid">
						<div class="span12">
							...
							<div class="block-fluid">
								<div class="row-form clearfix" >
									...
									<div class="span4"> 
										<input type="text" name="service_title" maxlength="30" class="service_title" onkeypress="return nameCharacter(event)"/>
									</div>
