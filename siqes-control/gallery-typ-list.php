				...
				<div class="row-fluid">
					<div class="span12">
						<div class="head clearfix">
							...
							<h1>Gallery Type List</h1>
							<ul class="buttons">
							<li>
								<a href="#" class="isw-settings"></a>
								<ul class="dd-list">
									<li><a href="add-gallery-type.php"><span class="isw-plus"></span>Add New</a></li>
								</ul>
							</li>
						</ul>           
						</div>
						<div class="block-fluid">
							...
							<thead>
								<tr>	
									<th width="15%">Gallery Type Name</th>
							...
							<tbody> 
								<?php
                                    ...
                                    $sql = mysql_query("select * from sqs_gallery_type order by gal_typ_name");
                                    $count = mysql_num_rows($sql);
									
                                    if($count>0){
                                        
                                        $sql_count="select * from sqs_gallery_type order by gal_typ_name";
								...
								?>
								<tr>
								<td><?php echo $rows['gal_typ_name']; ?></td>
								...
								<td>
									<a href="edit-gallery-type.php?action=editGallType&id=<?php echo $rows['gal_typ_id'] ?>">
										<i class="isb-edit"></i>
									</a>
									<!--<a href="blog-list.php?action=deleteBlog&blog_id=<?php echo $rows['gal_typ_id'] ?>" onclick="return confirm('Are you sure want to delete?')"><i class="isb-delete"></i>
									</a>-->
								</td>
                                </tr>
								<?php
