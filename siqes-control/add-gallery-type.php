...
if($_SESSION['admin']['name']=='')
	...
	if(isset($_REQUEST['Submit']) and !empty($_REQUEST['Submit']))
	{
		...
		if($resp==1 )
		{
			...
			echo "<script>window.location.href='add-gallery-type.php'</script>";
		}
	}
?>
<!DOCTYPE html>
...
<body>
    <div class="wrapper"> 
        ...
        <div class="content">
            ...
            <div class="workplace">
				<form name="frmgall_type" action="" method="post" onsubmit="return validGallType();" enctype="multipart/form-data"> 
					<div class="row-fluid">
						<div class="span12">
							<div class="head clearfix">
								<div class="isw-documents"></div>
								<h1>Add Gallery Type Details</h1>
								<ul class="buttons">
									<li>
							...
							<div class="block-fluid">
								<div class="row-form clearfix" >
									<div class="span2" ><b>Gallery Type Name <span style="color:red">*</span>:</b></div>
									<div class="span4"> 
									   <input type="text" name="typ_name" class="typ_name" maxlength="65" />
									</div>
								</div>
								<div class="row-form clearfix" >    
