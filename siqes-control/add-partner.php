...
if($_SESSION['admin']['name']=='')
	...
	if(isset($_REQUEST['Submit']) and !empty($_REQUEST['Submit']))
	{
		...
		if($resp==1 )
		{
			...
			echo "<script>window.location.href='add-partner.php'</script>";
		}
	}
?>
<!DOCTYPE html>
...
<body>
    <div class="wrapper"> 
        ...
        <div class="content">
            ...
            <div class="workplace">
				<form name="frmcpartner" action="" method="post" onsubmit="return validPartner();" enctype="multipart/form-data"> 
					<div class="row-fluid">
						<div class="span12">
							...
							<div class="block-fluid">
								<div class="row-form clearfix" >
									...
									<div class="span4"> 
										<input type="text" name="partner_title" maxlength="30" class="partner_title" onkeypress="return nameCharacter(event)"/>
									</div>
								...
								<div class="span2" ><b>Partner Logo <span style="color:red">*</span>:</b></div>
								   ...
								   <!--<div class="span2" ><b>Url <span style="color:red">*</span>:</b></div>
										<div class="span4" > 
										<input type="text" name="partner_url" class="partner_url" />
										</div>-->
								</div>
								<div class="row-form clearfix" > 
